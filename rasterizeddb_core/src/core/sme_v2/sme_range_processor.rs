    ...
    fn candidate_ranges_example_query_850() {
        let rules = vec![
            ...
            NumericCorrelationRule {
                ...
                ranges: smallvec::smallvec![
                    RowRange::from_row_id_range_inclusive(380, 450),
                    RowRange::from_row_id_range_inclusive(40, 120),
                    RowRange::from_row_id_range_inclusive(130, 320),
                ],
            },
        ];
            ...
            if std::is_x86_feature_detected!("avx2") {
                ...
                for i in 0..32u64 {
                    ...
                    rules.push(NumericCorrelationRule {
                        ...
                        ranges: smallvec::smallvec![RowRange::from_row_id_range_inclusive(i * 10, i * 10 + 5)],
                    });
                }
